...
foreign import javascript safe "$1[\"family\"]" js_getFamily ::
...
foreign import javascript safe "$1[\"style\"]" js_getStyle ::
        FontFace -> IO JSString
...
foreign import javascript safe "$1[\"weight\"]" js_getWeight ::
        FontFace -> IO JSString
...
foreign import javascript safe "$1[\"stretch\"]" js_getStretch ::
        FontFace -> IO JSString
...
foreign import javascript safe "$1[\"unicodeRange\"]"
...
foreign import javascript safe "$1[\"variant\"]" js_getVariant ::
        FontFace -> IO JSString
...
foreign import javascript safe "$1[\"featureSettings\"]"
