...
foreign import javascript safe "$1[\"a\"]" js_getA ::
        SVGMatrix -> IO Double
...
foreign import javascript safe "$1[\"b\"]" js_getB ::
        SVGMatrix -> IO Double
...
foreign import javascript safe "$1[\"c\"]" js_getC ::
        SVGMatrix -> IO Double
...
foreign import javascript safe "$1[\"d\"]" js_getD ::
        SVGMatrix -> IO Double
...
foreign import javascript safe "$1[\"e\"]" js_getE ::
        SVGMatrix -> IO Double
...
foreign import javascript safe "$1[\"f\"]" js_getF ::
        SVGMatrix -> IO Double
