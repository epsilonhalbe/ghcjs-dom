...
foreign import javascript safe "$1[\"fftSize\"]" js_getFftSize ::
...
foreign import javascript safe "$1[\"minDecibels\"]"
...
foreign import javascript safe "$1[\"maxDecibels\"]"
...
foreign import javascript safe "$1[\"smoothingTimeConstant\"]"
