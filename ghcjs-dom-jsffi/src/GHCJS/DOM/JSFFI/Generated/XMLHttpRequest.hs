...
foreign import javascript safe "$1[\"timeout\"]" js_getTimeout ::
...
foreign import javascript safe "($1[\"withCredentials\"] ? 1 : 0)"
...
foreign import javascript safe "$1[\"responseType\"]"
