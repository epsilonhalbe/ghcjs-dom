...
foreign import javascript safe "$1[\"mode\"]" js_getMode ::
...
foreign import javascript safe "$1[\"timestampOffset\"]"
...
foreign import javascript safe "$1[\"appendWindowStart\"]"
...
foreign import javascript safe "$1[\"appendWindowEnd\"]"
