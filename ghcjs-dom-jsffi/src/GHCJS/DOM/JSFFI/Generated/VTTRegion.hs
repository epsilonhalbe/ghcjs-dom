...
foreign import javascript safe "$1[\"width\"]" js_getWidth ::
        VTTRegion -> IO Double
...
foreign import javascript safe "$1[\"height\"]" js_getHeight ::
        VTTRegion -> IO Int
...
foreign import javascript safe "$1[\"regionAnchorX\"]"
...
foreign import javascript safe "$1[\"regionAnchorY\"]"
...
foreign import javascript safe "$1[\"viewportAnchorX\"]"
...
foreign import javascript safe "$1[\"viewportAnchorY\"]"
...
foreign import javascript safe "$1[\"scroll\"]" js_getScroll ::
        VTTRegion -> IO JSString
